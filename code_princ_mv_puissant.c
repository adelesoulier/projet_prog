...
int main(int argc, char * argv[]) {
    ...
    // On vérifie si les fichiers ont tous bien été lus:
    if (read1 == false || read2 == false || read3 == false || read4 == false){
        ...
        printf("Veuillez svp vérifier les paths de des fichiers NVELmoyenne.csv, EVELmoyenne.csv, gps_inputs.csv et pays_inputs.csv.\n");
        return 0;
    }
